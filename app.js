...
function openDrawer(content, onSubmit) {
  ...
  form.innerHTML = `<button type="button" class="drawer-x" aria-label="Close" id="drawerCloseBtn">×</button>${content}`;
  ...
  form.querySelector('#drawerCloseBtn')?.addEventListener('click', e => {
    e.preventDefault();
    closeDrawer();
  });
